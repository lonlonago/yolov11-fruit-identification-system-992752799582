...
YOLOv11 Fruit Identification System Based on Deep Learning YOLOv11's Fruit Classification and Recognition System (YOLOv11+YOLO dataset + UI interface + login registration interface + Python project source code + model)

nc: 6 classes,
Names: ['Golden Delicious', 'Granny Smith', 'Pear', 'Red Delicious', 'Red Nectarine', 'Yellow Peach'],
Dataset quantity: training set 5481 images, validation set 263.
